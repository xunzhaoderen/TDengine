...
class TDTestCase:
    ...
    def run(self):
        ...
        tdSql.execute('insert into tb1 using st tags("2021-06-10 0:00:00.123456789" , 1 ) values("2021-06-10 0:00:00.123456789+07:00" , 1.0);' )
        ...
        tdSql.execute('create stable st (ts timestamp ,speed float ) tags(time timestamp ,id int);')
        tdSql.execute('insert into tb1 using st tags("2021-06-10 0:00:00.123456" , 1 ) values("2021-06-10 0:00:00.123456+07:00" , 1.0);' )
        ...
        tdSql.execute('create stable st (ts timestamp ,speed float ) tags(time timestamp ,id int);')
        tdSql.execute('insert into tb1 using st tags("2021-06-10 0:00:00.123" , 1 ) values("2021-06-10 0:00:00.123+07:00" , 1.0);' )
        res = tdSql.getResult("select first(*) from tb1;")
        print(res)
