...
class TDTestCase:
    ...
    def run(self):
        ...
        self.jsonMaker.query_JSON_gen(50, "select last (*) from stb group by t1 limit 1000000", "5_3_1")
        self.jsonMaker.query_JSON_gen(50, "select count(*) from stb where ts > '2021-07-15 02:00:00.000' and col1 > 100000", "5_4_1")
